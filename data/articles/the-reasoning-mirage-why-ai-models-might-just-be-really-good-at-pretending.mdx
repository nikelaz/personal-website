...
<li id="reference-1">Hagendorff, T., Fabi, S., & Kosinski, M. (2024). The Illusion of Thinking: Understanding the Strengths and Limitations of Reasoning Models via the Lens of Problem Complexity. Apple Machine Learning Research. <br /><a href="https://machinelearning.apple.com/research/illusion-of-thinking" target="_blank" rel="noopener">https://machinelearning.apple.com/research/illusion-of-thinking</a></li>
</ol>
